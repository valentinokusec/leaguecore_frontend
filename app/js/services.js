...
//  return $resource('http://138.68.95.108:8080/getstreetlistfrompoly');
  ...
  //  return $resource('http://138.68.95.108:8080/getsubjectsfrompoly');
  ...
  //  return $resource('http://138.68.95.108:8080/getpoints');
...
phonecatServices.factory('DirectoryFromCircle', ['$resource',
  ...
  //  return $resource('http://138.68.95.108:8080/getstreetlistfromcircle');
return $resource('http://212.92.222.96:8090/getstreetlistfromcircle');
    ...
    phonecatServices.factory('PointsForCircle', ['$resource',
      ...
      //  return $resource('http://138.68.95.108:8080/getsubjectsfromcircle');
